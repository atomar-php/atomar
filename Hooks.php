...
CREATE TABLE `access` (
  ...
  `login_failed` int(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `extension` (
  ...
  `is_supported` int(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 0,
  `is_enabled` int(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 0,
  `is_update_pending` int(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `slug` (`slug`),
